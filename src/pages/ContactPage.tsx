      ...
      <div className="mx-auto max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Input className="rounded-none" type="email" placeholder="name@beispiel.de" required maxLength={255} />
          </div>
          <div className="space-y-2">
          ...
          <Button type="submit" className="w-full rounded-none text-sm uppercase tracking-wider" disabled={sending}>
