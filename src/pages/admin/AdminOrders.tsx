            ...
            {isLoading ? (
              ...
              orders?.map((o) => (
                <tr key={o.id} className="border-b border-border last:border-0">
                  ...
                  <td className="px-4 py-3">
                    <Button variant="outline" size="sm" className="rounded-none text-xs" onClick={() => setSelected(o)}>Details</Button>
                  </td>
                </tr>
              ))
            )}
          ...
          {selected && (
            <div className="space-y-4 text-sm">
              ...
              <div>
                ...
                <pre className="mt-1 whitespace-pre-wrap text-xs text-foreground">{JSON.stringify(selected.items, null, 2)}</pre>
              </div>
              {selected.notes && (
